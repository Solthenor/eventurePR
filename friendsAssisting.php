<?php // This page shows a list of the friends that are assisting to a specific event.
require_once('db.php');
...
// Query to find the friends who are assisting to the event
$db = db::getInstance();
$sql = "SELECT
            U.userName,
            U.userID,
...
<div id="wrapper">
    ...
    <div id="container">
        <div id="content">
            <!-- Button to go back to the event info page -->
            ...
            <!-- Loop that shows all the user's friends who are assisting to the event -->
            <?php if(isset($result)) {?>
